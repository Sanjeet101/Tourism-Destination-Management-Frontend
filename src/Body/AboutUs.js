...
class AboutUs extends Component{
  ...
  <div class="container py-5">
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        <p class="ead text-muted mb-0"><h1>About us</h1></p>
        <p class="lead text-muted mb-0"><h3>Trip Planner and Booking Site</h3></p>
        <p class="lead text-muted">A journey planner, trip planner, or route planner is a specialized search engine used 
        to find an optimal means of travelling between two or more given locations, sometimes using more than one 
        transport mode. ... Trip planners have been widely used in the travel industry by booking agents. TripPlanner was created as a tool to provide instant price estimates for complex trips. We know how important your time is, so we made it easy to use and don’t require you to spend time on formalities required with other trip-planning tools. <a href="/about" class="text-muted"></a>
        </p>
      </div>
      <div class="col-lg-6 d-none d-lg-block"><img src="https://www.tibetdiscovery.com/assets/images/nepal-tour/maps/Nepal-Tourist-Destinations-Map.jpg" alt="" class="img-fluid">
  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text-muted mb-4">This Site is User-friendly and you can choose here your
        favourite destination to visit including both inside and outside valley.</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
