  ...
  <button type="submit"><i class="fa fa-search"></i></button>
        ...
        favourite destination to visit including both inside and outside valley.</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
            ...
            <div class="row align-items-center mb-7">
              <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                <h2 class="font-weight-light">Trip Planner Benefits</h2>
              ...
              <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="https://nepcreation.com/uploads/portfolios/travel-nepal.png" alt="" class="img-fluid mb-4 mb-lg-3" /></div>
            </div>
            <div class="row align-items-center mb-3">
              <div class="col-lg-6 order-2 order-lg-4"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                <h2 class="font-weight-light">Planning engine that helps you see & do more</h2>
                <p class="font-italic text-muted mb-4">
                  <ul>
              ...
              <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="https://www.nepaltravelexperience.com/img/logo2.png" alt="" class="img-fluid mb-4 mb-lg-3" /></div>
            </div>
          </div>
        </div>
